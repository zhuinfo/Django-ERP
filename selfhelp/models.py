...
class WorkOrder(generic.BO):
    ...
    service = models.ForeignKey(Material,verbose_name=_("service name"),null=True,blank=True,limit_choices_to={"is_virtual":"1"},on_delete=models.CASCADE)
...
class WOItem(models.Model):
    ...
    """
    workorder = models.ForeignKey(WorkOrder,verbose_name=_("workorder"),on_delete=models.CASCADE)
    material = models.ForeignKey(Material,verbose_name=_("material"),null=True,blank=True,limit_choices_to={"is_virtual":"0"},on_delete=models.CASCADE)
...
class Activity(generic.BO):
    ...
    room = models.ForeignKey(Material,verbose_name=_("room"),blank=True,null=True,limit_choices_to={'tp':20},on_delete=models.CASCADE)
