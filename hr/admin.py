...
class EntryAdmin(generic.BOAdmin):
    ...
    fieldsets = [
        (None, {
            'fields': [
                ('code', 'position',), ('name', 'pinyin',), ('address', 'zipcode',), ('idcard', 'phone',), ('memo',), ('profile',)]}), (_('org distribute'), {
                    'fields': [
                        ('guider',), ('rank', 'ygxs',), ('category', 'probation_months',), ('probation_begin', 'probation_end',)], 'classes': ['collapse']})]
