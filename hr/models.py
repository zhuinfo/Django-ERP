...
class SalaryItem(ToStringMixin, models.Model):
    ...
    classification = models.CharField(
        ...
        default='10')
    plus_or_minus = models.CharField(
        _("plus or minus"),
        max_length=const.DB_CHAR_CODE_2,
...
class Entry(generic.BO):
    ...
    ygxs = models.CharField(_("employ ygxs"), max_length=const.DB_CHAR_CODE_2, blank=True,
                            null=True, choices=const.get_value_list('S019'), default='2')
    category = models.CharField(_("employ category"), max_length=const.DB_CHAR_CODE_2, blank=True,
                                null=True, choices=const.get_value_list('S018'), default='21')
...
class EmployeeSalaryItem(models.Model):
    ...
    calculate_way = models.CharField(
        _("calculate way"),
        max_length=const.DB_CHAR_CODE_2,
